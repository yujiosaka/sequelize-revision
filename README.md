...
| **[underscoredAttributes]**     | Boolean | `false`                                                                                                                | The **[revisionModel]** has a **[defaultAttributes.documentId]** `"documentId"`, and the **[revisionChangeModel]** has a **[defaultAttributes.revisionId]** `"revisionId`, by default, setting this option to `true` changes it to `"document_id"` and `"revision_id"`.                                            |
